    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                    <!-- Dashboard -->
                <flux:navlist.item icon="bolt" :href="route('dashboard')" :current="request()->routeIs('dashboard')"
                ...
                <!-- Projects -->
                <flux:navlist.item icon="briefcase" :href="route('projects')" :current="request()->routeIs('projects')"
                    wire:navigate>
                    {{ __('Projects') }}
                </flux:navlist.item>
